...
function imageFileWithFolder(imageFile)
	...
	if(application ~= nil)then
		if(application.SpriteHelperSettings ~= nil)then
			if(application.SpriteHelperSettings.imagesSubfolder ~= nil)then
				imgFile = application.SpriteHelperSettings.imagesSubfolder .. "/" .. imageFile;
			end
		end
	end
